...
if(!function_exists('gavias_post_type_portfolio')  ){
    function gavias_post_type_portfolio(){
      $labels = array(
          'name'               => __( 'Portfolios', 'inusti-themer' ),
          'singular_name'      => __( 'Portfolio', 'inusti-themer' ),
          'add_new'            => __( 'Add New Portfolio', 'inusti-themer' ),
          'add_new_item'       => __( 'Add New Portfolio', 'inusti-themer' ),
          'edit_item'          => __( 'Edit Portfolio', 'inusti-themer' ),
          'new_item'           => __( 'New Portfolio', 'inusti-themer' ),
          'view_item'          => __( 'View Portfolio', 'inusti-themer' ),
          'search_items'       => __( 'Search Portfolios', 'inusti-themer' ),
          'not_found'          => __( 'No Portfolios found', 'inusti-themer' ),
          'not_found_in_trash' => __( 'No Portfolios found in Trash', 'inusti-themer' ),
          'parent_item_colon'  => __( 'Parent Portfolio:', 'inusti-themer' ),
          'menu_name'          => __( 'Portfolios', 'inusti-themer' ),
      );
      ...
      $labels = array(
        'name'              => __( 'Categories', 'inusti-themer' ),
        'singular_name'     => __( 'Category', 'inusti-themer' ),
        'search_items'      => __( 'Search Category', 'inusti-themer' ),
        'all_items'         => __( 'All Categories', 'inusti-themer' ),
        'parent_item'       => __( 'Parent Category', 'inusti-themer' ),
        'parent_item_colon' => __( 'Parent Category:', 'inusti-themer' ),
        'edit_item'         => __( 'Edit Category', 'inusti-themer' ),
        'update_item'       => __( 'Update Category', 'inusti-themer' ),
        'add_new_item'      => __( 'Add New Category', 'inusti-themer' ),
        'new_item_name'     => __( 'New Category Name', 'inusti-themer' ),
        'menu_name'         => __( 'Categories', 'inusti-themer' ),
      );
