...
class GVAElement_Work_Process extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Work Process', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'GVA Work Process', 'inusti-themer' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Image', 'inusti-themer' ),
		...
		$this->add_responsive_control(
			'box_size',
			[
				'label' => __( 'Box Size', 'inusti-themer' ),
		...
		$this->add_responsive_control(
			'box_padding',
			[
				'label' => __( 'Box Padding', 'inusti-themer' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'default' => [
					'top' 		=> 50,
		...
		$this->add_control(
			'title_text',
			[
				'label' => __( 'Title & Description', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => __( 'This is the heading', 'inusti-themer' ),
		...
		$this->add_control(
			...
			[
				'label' => 'Number text',
				'type' => Controls_Manager::TEXT,
				'default' => __( '01', 'inusti-themer' ),
				'placeholder' => __( 'Enter your number', 'inusti-themer' ),
			]
		);
		...
		$this->add_control(
			'header_tag',
			[
				'label' => __( 'Title HTML Tag', 'inusti-themer' ),
		...
		$this->start_controls_section( //** Section Button
			'section_line',
			[
				'label' => __( 'Line', 'inusti-themer' ),
			]
		);
		$this->add_control(
			'line_left',
			[
				'label' => __( 'Display Line Left', 'inusti-themer' ),
		...
		$this->add_control(
			'line_right',
			[
				'label' => __( 'Display Line Right', 'inusti-themer' ),
				'type'      => Controls_Manager::SWITCHER,
            'default'   => 'yes',
			]
		);
		$this->add_control(
			'line_background',
			[
				'label' => __( 'Line Background', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .gsc-work-process .box-content .box-background' => 'background-color: {{VALUE}};',
		...
		$this->add_control(
			'icon_background',
			[
				'label' => __( 'Icon Background', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'icon_color_hover',
			[
				'label' => __( 'Hover | Icon Color', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Hover | Icon Background', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			'icon_box_width',
			[
				'label' => __( 'Icon Box Width', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 105,
				],
		...
		$this->add_responsive_control(
			'icon_padding',
			[
				'label' => __( 'Padding', 'inusti-themer' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'default' => [
					'top' 		=> 30,
		...
		$this->add_responsive_control(
			'title_bottom_space',
			[
				'label' => __( 'Spacing', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
