...
class GVAElement_Heading_Block extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Heading Block', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your Sub Title', 'inusti-themer' ),
				'label_block' => true
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your title', 'inusti-themer' ),
				'default' => __( 'Add Your Heading Text Here', 'inusti-themer' ),
				'label_block' => true
			]
		);
		...
		$this->add_control(
			'description_text',
			[
				'label' => __( 'Description', 'inusti-themer' ),
				'type' => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => __( 'Enter Your Description', 'inusti-themer' ),
				'condition' => [
					'style' => 'style-1'
				]
			]
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'style-1' => esc_html__('Style I: Default', 'inusti-themer'),
				],
				'default' => 'style-1',
			]
		);
		...
		$this->add_control(
			'header_tag',
			[
				'label' => __( 'HTML Tag', 'inusti-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->add_control(
			'align',
			[
				'label' => __( 'Alignment Text', 'inusti-themer' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'inusti-themer' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'inusti-themer' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => __( 'Right', 'inusti-themer' ),
		...
		$this->add_control(
			'box_align',
			[
				'label' => __( 'Alignment Box', 'inusti-themer' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'inusti-themer' ),
		...
		$this->add_responsive_control(
			'max_width',
			[
				'label' => __( 'Max Width (px)', 'inusti-themer' ),
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enable/Disable Icon Heading', 'inusti-themer' ),
				'default' => 'no'
			]
		);
		...
		$this->add_control(
			'icon_image',
			[
				'label' => __( 'Icon Image', 'inusti-themer' ),
		...
		$this->start_controls_section( //** Section Icon
			'section_video',
			[
				'label' => __( 'Video Top', 'inusti-themer' ),
			]
		);
		$this->add_control(
			'video',
			[
				'label' => __( 'Video', 'inusti-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Enable/Disable Video Heading', 'inusti-themer' ),
				'default' => 'no'
			]
		);
		$this->add_control(
			'video_url',
			[
				'label' => __( 'Video Youtube or Vimeo URL', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
					'video' => 'yes',
				],
		...
		$this->start_controls_section( //** Section Button
			'section_button',
			[
				'label' => __( 'Button', 'inusti-themer' ),
			]
		);
		$this->add_control(
			'button_url',
			[
				'label' => __( 'Button URL', 'inusti-themer' ),
		...
		$this->add_control(
			'button_text',
			[
				'label' => __( 'Button Text', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'Read More'
			]
		);
		$this->add_control(
			'button_style',
			[
				'label' => __( 'Button Style', 'inusti-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'btn-theme' 		=> esc_html__('Button Theme', 'inusti-themer'),
					'btn-theme-2' 		=> esc_html__('Button Theme Second', 'inusti-themer'),
					'btn-black' 		=> esc_html__('Button Black', 'inusti-themer')
				],
				'default' => 'btn-theme',
			]
		);
		$this->add_control(
			'button_size',
			[
				'label' => __( 'Button Size', 'inusti-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' 					=> esc_html__('Button Size Default', 'inusti-themer'),
					'btn-size-small' 	=> esc_html__('Button Size Small', 'inusti-themer')
				],
				'default' => '',
			]
		);
		$this->add_control(
			'button_color',
			[
				'label' => __( 'Button Text Color', 'inusti-themer' ),
		...
		$this->add_control(
			'button_background',
			[
				'label' => __( 'Button Background', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'button_color_hover',
			[
				'label' => __( 'Button Color Hover', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Background Hover', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_video_style',
			[
				'label' => __( 'Video Button', 'inusti-themer' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Primary Color', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'video_color',
			[
				'label' => __( 'Text Button Video Color', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'video_size',
			[
				'label' => __( 'Video Button Size', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 92,
				],
		...
		$this->add_responsive_control(
			'box_space',
			[
				'label' => __( 'Heading Element Space Bottom', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
		...
		$this->add_responsive_control(
			'title_space',
			[
				'label' => __( 'Title Spacing', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 30,
				],
		...
		$this->add_responsive_control(
			'sub_title_space',
			[
				'label' => __( 'Sub Title Spacing', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
		...
		$this->add_responsive_control(
			'description_space',
			[
				'label' => __( 'Description Spacing', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 45,
				], 
