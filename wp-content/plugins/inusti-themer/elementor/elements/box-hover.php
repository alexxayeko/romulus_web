...
class GVAElement_Box_Hover extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Box Hover', 'inusti-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'style-1',
                'options' => [
                  'style-1' => esc_html__('Style I - Carousel', 'inusti-themer'),
                ]
            )
         );
        ...
        $repeater->add_control(
         ...
         $repeater->add_control(
            ...
            [
                ...
                'default'    => [
                    'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                ],
        ...
        $repeater->add_control(
            'selected_icon',
            [
                'label'      => __('Choose Icon', 'inusti-themer'),
         ...
         $repeater->add_control(
            ...
            [
                ...
                'default'     => 'I was impresed by the indutri services, lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia.',
                'label_block' => true,
                'rows'        => '10',
            ]
        );
        ...
        $this->add_control(
            'content_items',
            [
                'label'       => __('Content Item', 'inusti-themer'),
                ...
                'default'     => array(
                    array(
                        ...
                        'box_image'    => [
                            'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/image-4.jpg',
                        ],
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'inusti-themer' ),
                    ),
                    array(
                        'box_title'  => esc_html__('Civil Rights'),
                        'box_image'    => [
                            'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/image-5.jpg',
                        ],
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'inusti-themer' ),
                    ),
                    array(
                        ...
                        'box_image'    => [
                            'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/image-6.jpg',
                        ],
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'inusti-themer' ),
                    ),
                    array(
        ...
        $this->add_control(
            'box_height',
            [
                'label'      => __('Box Height', 'inusti-themer'),
        ...
        $this->add_control(
            'icon_background',
            [
                'label'     => __('Icon Background Color', 'inusti-themer'),
        ...
        $this->add_control(
            'icon_border_radius',
            [
                'label'      => __('Icon Border Radius', 'inusti-themer'),
