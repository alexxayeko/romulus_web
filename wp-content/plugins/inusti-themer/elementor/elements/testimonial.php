...
class GVAElement_Testimonial extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Testimonials', 'inusti-themer');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => __('Testimonials', 'inusti-themer'),
            ]
        );
        $this->add_control(
            'style',
            array(
                ...
                'options' => [
                  ...
                  'style-2' => esc_html__('Style II - Grid', 'inusti-themer')
                ]
            )
         );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => array(
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'inusti-themer' ),
                        'testimonial_name'     => esc_html__( 'Christine Eve', 'inusti-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'inusti-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ),
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'inusti-themer' ),
                        'testimonial_name'     => esc_html__( 'Kevin Smith', 'inusti-themer' ),
                        'testimonial_job'      => esc_html__( 'Customer', 'inusti-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ),
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'inusti-themer' ),
                        'testimonial_name'     => esc_html__( 'Jessica Brown', 'inusti-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'inusti-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ...
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'inusti-themer' ),
                        'testimonial_name'     => esc_html__( 'David Anderson', 'inusti-themer' ),
                        'testimonial_job'      => esc_html__( 'Customer', 'inusti-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
                    ...
                    array(
                        'testimonial_content'  => esc_html__( 'I was impresed by the moling services, not lorem ipsum is simply free text of used by refreshing. Neque porro este qui dolorem ipsum quia.', 'inusti-themer' ),
                        'testimonial_name'     => esc_html__( 'Susan Neill', 'inusti-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'inusti-themer' ),
                        'testimonial_image'    => [
                            'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/testimonial.png',
                        ]
