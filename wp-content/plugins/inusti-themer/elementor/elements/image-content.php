...
class GVAElement_Image_Content extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Image Content', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'skin-v1' => esc_html__('Style I', 'inusti-themer'),
					'skin-v2' => esc_html__('Style II', 'inusti-themer'),
					'skin-v3' => esc_html__('Style III', 'inusti-themer'),
					'skin-v4' => esc_html__('Style IV', 'inusti-themer'),
				],
				'default' => 'skin-v1',
			]
		);
		...
		$this->add_control(
			'image_second',
			[
				'label' => __( 'Choose Image Second', 'inusti-themer' ),
				'type' => Controls_Manager::MEDIA,
				'label_block' => true,
				'default' => [
					'url' => Elementor\Utils::get_placeholder_image_src(),
		...
		$this->add_control(
			'triangles_style',
			[
				'label' => __( 'Enable Triangles Style', 'inusti-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Enable Triangles Style', 'inusti-themer' ),
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'image_triangles_1',
			[
				'label' => __( 'Choose Triangles Image I', 'inusti-themer' ),
				'type' => Controls_Manager::MEDIA,
				'selectors' => [
		...
		$this->add_control(
			'image_triangles_2',
			[
				'label' => __( 'Choose Triangles Image II', 'inusti-themer' ),
				'type' => Controls_Manager::MEDIA,
				'selectors' => [
		...
		$this->add_control(
			'link_text',
			[
				'label' => __( 'Text Link', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => __( 'Read More', 'inusti-themer' ),
				'default' => __( 'Read More', 'inusti-themer' ),
				'condition' => [
					'style!' => ['skin-v1', 'skin-v2'],
				],
			]
		...
		$this->add_control(
			'title_space_bottom',
			[
				'label' => __( 'Space Bottom', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 20,
				],
