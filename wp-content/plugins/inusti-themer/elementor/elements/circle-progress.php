...
class GVAElement_Circle_Progress extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Circle Progress', 'inusti-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'placeholder' => esc_html__( 'Enter your title', 'inusti-themer' ),
				'default'	  => esc_html__( 'Projects Completed', 'inusti-themer' )
			]
		);
		$this->add_control(
			'empty_fill',
			[
				'label' => __( 'Color EmptyFill', 'inusti-themer' ),
		...
		$this->add_control(
			'number',
			[
			  	'label' => __( 'Percentage', 'inusti-themer' ),
	 	...
	 	$this->add_control(
			'thickness',
			[
			  	'label' => __( 'Thickness', 'inusti-themer' ),
			  	'type' => Controls_Manager::NUMBER,
				'min' => 1,
			  	'max' => 50,
			  	'step' => 1,
		...
		$this->add_control(
			'percentage_color',
			[ 
				'label' => __( 'Percentage Color', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
 ...
 $widgets_manager->register_widget_type(new GVAElement_Circle_Progress());
