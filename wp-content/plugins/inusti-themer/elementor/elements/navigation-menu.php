...
class GVAElement_Navigation_Menu extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Navigation Menu', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'sub_menu_min_width',
			[
				'label' => __( 'Submenu Min Width (px)', 'inusti-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'inusti-themer' ),
      ...
      $this->end_controls_tabs();
		...
		$this->add_responsive_control(
			'main_menu_padding',
			[
				'label' => __( 'Menu Item Padding', 'inusti-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sub Menu', 'inusti-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
      ...
      $this->add_control(
         ...
         [
            'label'     => __('Link Color', 'inusti-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
