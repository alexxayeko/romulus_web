...
class GVAElement_Portfolio extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Portfolio', 'inusti-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'portfolio-style-1'         => __( 'Item Portfolio Style I', 'inusti-themer' ),
                    'portfolio-style-2'         => __( 'Item Portfolio Style II', 'inusti-themer' )
                ],
                'condition' => [
        ...
        $this->add_control(
            'isotope_filter',
            [
                'label'     => __('Isotope Filter', 'inusti-themer'),
        ...
        $this->add_control(
            'align',
            [
                'label' => __( 'Alignment Filter', 'inusti-themer' ),
