...
class GVAElement_Search_Box extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Search Box', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'icon_color_hover',
			[
				'label' => __( 'Color Hover', 'inusti-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_control(
			'icon_background',
			[
				'label' => __( 'Background', 'inusti-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Hover', 'inusti-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_responsive_control(
			'content_size',
			[
				'label' => __( 'Content Width', 'inusti-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 200,
				],
