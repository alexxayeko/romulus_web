...
class GVAElement_Video_Carousel extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Video Carousel', 'inusti-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            'video_link',
            [
                'label'   => __('Video Link', 'inusti-themer'),
                'default' => 'https://www.youtube.com/watch?v=knTiUD5IAww',
                'type'    => Controls_Manager::TEXT,
                'description' => esc_html__( 'You can add youtube/vimeo video link', 'inusti-themer' )
            ]
        );
        ...
        $this->add_control(
            'videos_content',
            [
                'label'       => __('Video Content', 'inusti-themer'),
