...
class GVAElement_Icon_Box_Group extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Icon Box Group', 'inusti-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
          ...
          [
            ...
            'placeholder' => __( 'Active', 'inusti-themer' ),
            'default' => 'no'
          ]
        );
        ...
        $this->add_control(
          ...
          [
            ...
            'default'     => array(
              array(
                'title'  => esc_html__( 'We’re providing the best industrial services', 'inusti-themer' ),
              ),
              array(
                'title'  => esc_html__( 'We’re providing the best industrial services', 'inusti-themer' ),
              ),
