...
class GVAElement_Logo extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Logo', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'image',
			[
				'label' => __( 'Choose Logo Image', 'inusti-themer' ),
				'type' => Controls_Manager::MEDIA,
				'label_block' => true,
				'default' => [
					'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/logo.png',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'max_width',
			[
				'label' => __( 'Max Width', 'inusti-themer' ),
		...
		$this->start_controls_section(
			'section_box_style',
			[
				'label' => __( 'Logo Styling', 'inusti-themer' ),
