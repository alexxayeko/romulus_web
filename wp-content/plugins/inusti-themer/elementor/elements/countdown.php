...
class GVAElement_Countdown extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Countdown', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'year',
			[
				'label' => __( 'Year', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => date('Y'),
				'placeholder' => __( 'ex: 2022', 'inusti-themer' ),
				'label_block' => true
			]
		);
		$this->add_control(
			'month',
			[
				'label' => __( 'Month', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '12',
				'placeholder' => __( 'ex: 12', 'inusti-themer' ),
			]
		);
		$this->add_control(
			'day',
			[
				'label' => __( 'Day', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '01',
				'placeholder' => __( 'ex: 01', 'inusti-themer' ),
			]
		);
		$this->add_control(
			'hour',
			[
				'label' => __( 'Hour', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '00',
				'placeholder' => __( 'ex: 00', 'inusti-themer' ),
			]
		);
		$this->add_control(
			'minutes',
			[
				'label' => __( 'Minutes', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '00',
				'placeholder' => __( 'ex: 00', 'inusti-themer' ),
			]
		...
		$this->add_control(
			'align',
			[
				'label' => __( 'Alignment', 'inusti-themer' ),
