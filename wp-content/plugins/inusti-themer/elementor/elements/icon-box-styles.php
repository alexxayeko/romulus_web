...
class GVAElement_Icon_Box_Styles extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Icon Box Styles', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'GVA Icon Box Style', 'inusti-themer' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'There are many new variations of pasages of available text.', 'inusti-themer' ),
		...
		$this->start_controls_section( //** Section Button
			'section_button',
			[
				'label' => __( 'Button & Link', 'inusti-themer' ),
			]
		);
		$this->add_control(
			'button_url',
		...
		$this->start_controls_section(
			'section_box_style',
			[
				'label' => __( 'Box Style', 'inusti-themer' ),
		...
		$this->add_responsive_control(
			'box_height',
			[
				'label' => __( 'Min Height', 'inusti-themer' ),
