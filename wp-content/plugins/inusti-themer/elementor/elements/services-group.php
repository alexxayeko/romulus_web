...
class GVAElement_Services_Group extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Services Group', 'inusti-themer');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'style-1' => esc_html__('Style I', 'inusti-themer'),
                    'style-2' => esc_html__('Style II', 'inusti-themer'),
                ],
                'default' => 'style-1',
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => [
                    'url' => GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/service-1.jpg',
                ],
        ...
        $this->add_control(
          'services_content',
          [
            'label'       => __('Service Content Item', 'inusti-themer'),
            'type'        => Controls_Manager::REPEATER,
            'fields'      => $repeater->get_controls(),
            'title_field' => '{{{ title }}}',
            'default'     => array(
              array(
                'title'  => esc_html__( 'Interior Design', 'inusti-themer' ),
              ),
              array(
                'title'       => esc_html__( 'A rchitectures', 'inusti-themer' ),
              ),
              array(
                'title'  => esc_html__( 'Desiging Solutions', 'inusti-themer' ),
              ),
              array(
                'title'  => esc_html__( 'Redesigning Dreams', 'inusti-themer' ),
              ),
            )
          ]
        );
...
$widgets_manager->register_widget_type(new GVAElement_Services_Group());
