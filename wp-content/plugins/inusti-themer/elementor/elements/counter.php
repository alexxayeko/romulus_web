...
class GVAElement_Counter extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Counter', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'selected_icon',
			[
				'label' => __( 'Icon Class', 'inusti-themer' ),
		...
		$this->add_control(
			'text_before',
			[
				'label' => __( 'Text Before Number', 'inusti-themer' ),
		...
		$this->add_control(
			'text_after',
			[
				'label' => __( 'Text After Number', 'inusti-themer' ),
				'type' => Controls_Manager::TEXT,
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => __( 'Icon Size', 'inusti-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Number Text', 'inusti-themer' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
