...
class GVAElement_Call_To_Action extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Call To Action', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
				'button-left' => esc_html__('Button Left', 'inusti-themer'),            
            'button-right' => esc_html__('Button Right', 'inusti-themer'),   
            'button-bottom' => esc_html__('Button Bottom Left', 'inusti-themer'),   
            'button-center' => esc_html__('Button Bottom Center', 'inusti-themer'),
				],
