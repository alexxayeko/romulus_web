...
class GVAElement_Tabs_Content extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Tabs Content', 'inusti-themer' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => __( 'GVA Tabs Content', 'inusti-themer' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Tab Title', 'inusti-themer' ),
				'placeholder' => __( 'Tab Title', 'inusti-themer' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Tab Content', 'inusti-themer' ),
				'placeholder' => __( 'Tab Content', 'inusti-themer' ),
		...
		$this->add_control(
			'tabs',
			[
				'label' => __( 'Tabs Items', 'inusti-themer' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => __( 'Our Mission', 'inusti-themer' ),
						'tab_content' => __( "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.", 'inusti-themer' ),
					],
					[
						'tab_title' => __( 'Our Vision', 'inusti-themer' ),
						'tab_content' => __( "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.", 'inusti-themer' ),
					],
					[
						'tab_title' => __( 'Our History', 'inusti-themer' ),
						'tab_content' => __( "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.", 'inusti-themer' ),
					],
				],
		...
		$this->add_responsive_control(
			'tab_item_width',
			[
				'label' => __( 'Tab Item Width', 'inusti-themer' ),
		...
		$this->add_control(
			'background_active',
			[
				'label' => __( 'Active Background Color', 'inusti-themer' ),
		...
		$this->add_control(
			'color_active',
			[
				'label' => __( 'Active Color', 'inusti-themer' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#18212e',
				'selectors' => [
