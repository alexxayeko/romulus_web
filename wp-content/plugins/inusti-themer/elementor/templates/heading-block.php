<?php
   ...
   if($settings['icon'] == 'yes'){
      ...
      if(empty($icon_image)) $icon_image = GAVIAS_INUSTI_PLUGIN_URL . 'elementor/assets/images/icon-heading.png';
   }

   $this->add_render_attribute( 'block', 'class', [ 'align-' . $settings['align'], $settings['style'], 'widget gsc-heading', 'box-align-' . $settings['box_align'] ]  );
   ...
   <div <?php echo $this->get_render_attribute_string( 'block' ) ?>>
      <div class="content-inner">
         ...
         <?php if($sub_title){ ?>
            <div class="clearfix"><div <?php echo $this->get_render_attribute_string( 'sub_title' ); ?>><span><?php echo esc_html($sub_title); ?></span></div></div>
         <?php } ?>  
