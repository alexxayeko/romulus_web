<?php
   ...
   $this->add_render_attribute('wrapper', 'class', ['gva-locations-map' ]);
                           ...
                           <div class="marker">
                              ...
                              <div class="info">
                                 ...
                                 <?php if( isset($item['link']['url']) && $item['link']['url'] ){ ?>
                                    <?php $this->gva_render_link_html('<span>' . esc_html__( 'Read More', 'inusti-themer' ) . '</span>', $item['link'], 'link-visit btn-theme btn-size-small'); ?>
                                 <?php } ?>
