...
class Inusti_Themer_Widget_Recent_Posts extends WP_Widget {
   ...
   */
   ...
   public function widget( $args, $instance ) {
      ...
      $default_title = esc_html__( 'Recent Posts', 'inusti-themer' );
...
function inusti_themer_widget_recent_posts(){
   return register_widget('Inusti_Themer_Widget_Recent_Posts');
}

add_action('widgets_init', 'inusti_themer_widget_recent_posts');
