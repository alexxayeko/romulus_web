<?php 
  get_header(apply_filters('inusti_get_header_layout', null )); 
  wp_enqueue_script( 'waypoints' );
  
  $page_id = inusti_id();
  $page_title_style = get_post_meta($page_id, 'inusti_page_title_style', true );
    ...
    <div class="main-page-content row">
      ...
      <div class="content-page col-xs-12">      
        <?php while ( have_posts() ) : the_post(); ?>
          <?php
            $team_position = get_post_meta(get_the_id(), 'inusti_team_position', true );
            ...
            $team_quote = get_post_meta(get_the_id(), 'inusti_team_quote', true );
            $team_email = get_post_meta(get_the_id(), 'inusti_team_email', true );
            $team_phone = get_post_meta(get_the_id(), 'inusti_team_phone', true );
            $team_address = get_post_meta(get_the_id(), 'inusti_team_address', true );
            ...
            <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 col-xs-12 team-image">
              <div class="team-thumbnail clearfix">
                ...
                <div class="team-content clearfix">
                  <h3 class="heading-contact"><?php echo esc_html__('Contact Info', 'inusti') ?></h3>
                  <?php if($team_email){ ?>
                    <div class="team-email"><?php echo esc_html__('Email: ', 'inusti') ?>
                      <a href="mailto:<?php echo esc_html( $team_email ) ?>"><?php echo esc_html( $team_email ) ?></a>
                    </div>
                  <?php } ?>

                  <?php if($team_phone){ ?>
                    <div class="team-phone"><?php echo esc_html__('Phone: ', 'inusti') ?>
            ...
            <div class="col-xl-8 col-lg-8 col-md-7 col-sm-12 col-xs-12 team-right-content">
              ...
              <?php if( is_array($team_educations) && isset($team_educations[1]) ){ ?>
                <div class="team-educations">
                  <h3 class="heading"><?php echo esc_html__('Educations', 'inusti') ?></h3>
              ...
              <?php if( is_array($team_skills) && isset($team_skills[1]) ){ ?>
                <div class="team-skills clearfix">
                  <h3 class="heading"><?php echo esc_html__('Skills', 'inusti') ?></h3>
                  <div class="clearfix">
