 ...
 */
    ...
    $default_sidebar_config = inusti_get_option('single_portfolio_sidebar', 'right-sidebar'); 
    $default_left_sidebar = inusti_get_option('single_portfolio_left_sidebar', 'blog_sidebar');
    $default_right_sidebar = inusti_get_option('single_portfolio_right_sidebar', 'blog_sidebar');
          ...
          <div id="wp-content" class="wp-content clearfix">
            <?php while ( have_posts() ) : the_post(); ?>
              ...
              <div class="portfolio-thumbnail">
                <?php $gallery = get_post_meta(get_the_ID(), 'inusti_gallery_images', false ); ?>
