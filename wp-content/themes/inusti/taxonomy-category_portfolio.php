 ...
 */
   ...
   $sidebar_layout_config = inusti_get_option('archive_portfolio_sidebar', 'right-sidebar'); 
   $left_sidebar = inusti_get_option('archive_portfolio_left_sidebar', 'portfolio_sidebar');
   $right_sidebar = inusti_get_option('archive_portfolio_right_sidebar', 'portfolio_sidebar');
   ...
   $columns_lg = inusti_get_option('portfolio_columns_lg', '4');
   $columns_md = inusti_get_option('portfolio_columns_md', '3');
   $columns_sm = inusti_get_option('portfolio_columns_sm', '2');
   $columns_xs = inusti_get_option('portfolio_columns_xs', '1');
