 ...
 */
 	get_header(); 
  	...
  	$sidebar_layout_config = inusti_get_option('archive_post_sidebar', ''); 
  	$left_sidebar = inusti_get_option('archive_post_left_sidebar', '');  
  	$right_sidebar = inusti_get_option('archive_post_right_sidebar', ''); 
		  		...
		  		<div id="wp-content" class="wp-content">
			 		...
			 		<?php else: ?>
						<div class="search-no-results-content">
							<div class="message"><?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'inusti' ); ?></div>
							<?php get_search_form() ?>
						</div>
			 		<?php endif ?>
