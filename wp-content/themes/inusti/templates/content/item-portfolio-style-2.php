<?php 
   ...
   if(!empty($item_cats) && !is_wp_error($item_cats)){
      foreach((array)$item_cats as $item_cat){
         ...
         $output .= '<a href="'.get_category_link( $item_cat->term_id ).'" title="' . esc_attr( sprintf( esc_attr__( "View all posts in %s", 'inusti' ), $item_cat->name ) ) . '">'.$item_cat->name.'</a>'.$separator;
      }
...
<div class="<?php echo esc_attr($item_classes) ?>">
   <div class="portfolio-block portfolio-v2">      
      <div class="images">
         ...
         <a class="link" href="<?php the_permalink(); ?>"><i class="fas fa-link"></i></a>
      </div>
