...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
  ...
  $sidebar_layout_config = inusti_get_option('woo_sidebar_config', '');
  $left_sidebar = inusti_get_option('woo_left_sidebar', '');
  $right_sidebar = inusti_get_option('woo_right_sidebar', '');
              ...
              <?php woocommerce_product_subcategories(); ?>  
                  ...
                  <div class="shop-loop-container">
                    <div class="gvawooaf-before-products layout-grid">
                      ...
                      <?php do_action('inusti_woocommerce_active_filter' );  ?>
